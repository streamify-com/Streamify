export default function PrivacyPolicySection() {
  return (
    <div className="px-6 py-32 lg:px-8">
      <div className="mx-auto max-w-3xl font-medium leading-7 text-primary-muted">
        <h1 className="mt-2 text-3xl font-bold tracking-tight text-primary sm:text-4xl">
          Datenschutzerklärung
        </h1>
        <h2 className="mt-8 text-2xl font-bold tracking-tight text-primary">
          1. Datenschutz auf einen Blick
        </h2>
        <h3 className="mt-8 text-xl font-bold tracking-tight text-primary">
          Allgemeine Hinweise
        </h3>
        ...
        <h4 className="mt-4 text-lg font-bold tracking-tight text-primary">
        ...
        <p className="mt-6 text-md leading-8">
          ...
          <br />
          <br />
          Votan Enterprise UG (haftungsbeschränkt) Franziskaweg 1
          <br />
          70599 Stuttgart
          <br />
          E-Mail: tin.votan@votan-enterprise.com
          <br />
          <br />
        ...
        <p className="mt-6 text-md leading-8">
          ...
          <br />
          <br />• Wenn wir Ihre personenbezogenen Daten nicht mehr benötigen,
