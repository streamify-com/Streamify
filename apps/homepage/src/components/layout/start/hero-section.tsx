        ...
        <HomepageContainer>
          ...
          <div className="mx-auto text-center">
            <motion.h1
              ...
              className="font-customFont from-standard via-highlight to-standard inline-block bg-gradient-to-t bg-clip-text text-4xl text-transparent md:text-5xl lg:text-6xl"
            >
              {t("title-1")}
              &nbsp;
            ...
            {/* <motion.h2
              ...
              className="font-regular from-standard via-highlight to-standard inline-block bg-gradient-to-t bg-clip-text text-4xl text-transparent lg:text-4xl mt-6"
            >
              {t("title-4")}
            </motion.h2> */}
            ...
            <motion.h3
              ...
              className="mt-10 mb-6 text-highlight md:text-sm text-xs uppercase"
            >
              {t("highlight")}
            </motion.h3>
          </div>
